    ...
    <div className="flex flex-wrap md:flex-nowrap space-y-4 md:space-y-0 md:space-x-3 mt-[2%] absolute left-1 ml-[15%] md:ml-[5%] justify-around w-[1575px]">
      ...
      <div className="relative flex p-4 rounded-3xl w-full md:w-[30%]">
        ...
        <div className="absolute text-black p-4 h-[450px] text-center justify-center ml-20">
          <h3 className="font-semibold text-white text-xl mr-5 mt-4">AIR</h3>
          <h3 className="font-semibold text-xl text-white">PUFFIER</h3>
          <p className="text-gray-500 text-xl md:text-xl mt-4">From</p>
          <p className="text-green-600 text-xl md:text-xl font-bold">$169</p>
        </div>
      </div>

      <div className="relative flex p-4 rounded-3xl w-full md:w-[30%]">
        <img
          src="https://s3-alpha-sig.figma.com/img/50a5/4535/fafd06131fa1ff875bd8fe9c42636008?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=jN~edOq-7s7SItqEYkmjzuKgo-NSIFdrZ2ChksWQaIGVsJNB-7-5YnIIGCqWDYFHICtly5qW8HsqzJ0OqKPTG6en7N6mDqI3UXvFKHk3j6Tx0xMjx8j-XKYREc53hx7RH-8RCVVMnUf84TJqVAEOITp6XUsO6lV33-XsOnnoJmXRY9DZzLp2ai5BxdMZPwdDGDmafzYWM6vg8i0vhbTR1Lrx5vGnCggYptmRlc5opYPh~pzDIRiPtbHcAE3lbp096k~6cePsaJ9Ou7ck1kGRp6V82vv0T5W04lq5tOQVQEysv8w43~3vHWEXbcIBTOLd8aad1eO0DLctOO2ivsIOcA__"
          alt="Smartwatch"
          className="w-full h-[300px] object-cover rounded-xl"
        />
        <div className="absolute text-black p-4 h-[450px] text-center justify-center ml-16">
          <h3 className="font-thin text-white">WASHING MACHINE</h3>
          <h3 className="font-semibold text-xl text-white">ANATICO</h3>
          <h3 className="font-semibold text-xl text-white">MAX 2</h3>
